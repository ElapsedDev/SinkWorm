...
public class Persist {
    ...
    public File getFile(String name) {
        File directory = new File("data"); // Ensure base directory exists
        if (!directory.exists()) {
            if (!directory.mkdirs()) {
                Logger.getLogger(Configurations.LOGGER_TITLE).log(Level.SEVERE, "Failed to create database directory!");
            }
        }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            Logger.getLogger(Configurations.LOGGER_TITLE).log(Level.INFO, "Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            Logger.getLogger(Configurations.LOGGER_TITLE).log(Level.WARNING, "Using default as I failed to load: " + file);
            ...
            Logger.getLogger(Configurations.LOGGER_TITLE).log(Level.WARNING, "Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            Logger.getLogger(Configurations.LOGGER_TITLE).log(Level.WARNING, ex.getMessage());
        }
    ...
    public <T> T load(Type typeOfT, File file) {
        ...
        try {
            ...
            Logger.getLogger(Configurations.LOGGER_TITLE).warning(ex.getMessage());
        }
